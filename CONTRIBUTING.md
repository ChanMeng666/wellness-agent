# Contributing to Wellness Agent
...
If you find a bug, please [open an issue](https://github.com/ChanMeng666/wellness-agent/issues/new) with:
...
Have an idea? [Open a feature request](https://github.com/ChanMeng666/wellness-agent/issues/new) describing the problem you want to solve and your proposed solution.

### Submitting Changes

1. **Fork** the repository and **clone** your fork:
   ```bash
   git clone https://github.com/<your-username>/wellness-agent.git
   cd wellness-agent
   ```
